...
$token = "64c95dfd0c164bf1e6545b9877914f7e2dd0b7a7";
$secret = "ea8c4766b2b31bad47fc1e91ca02686f4c32ffbf";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $responseRaw = $dadata->clean("name", $_POST['user_name']." ".$_POST['user_second_name']." ".$_POST['user_last_name']);
    $response = $responseRaw[0]['result'];
    echo '<pre>';
    print_r("Стандартизированное ФИО: \n $response\n\nСырой ответ API:\n");
    print_r($responseRaw[0]);
    echo '</pre>';
}
